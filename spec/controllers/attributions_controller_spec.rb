...
RSpec.describe AttributionsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new attribution" do

        post :create, params: {attribution: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(attribution_url(Attribution.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new attribution" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the attribution" do
        attribution = Attribution.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the attribution" do
        attribution = Attribution.create! valid_attributes
